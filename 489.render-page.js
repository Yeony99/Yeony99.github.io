...
// EXTERNAL MODULE: ./node_modules/@deckdeckgo/highlight-code/dist/esm/index-5f714435.js
var index_5f714435 = __webpack_require__(5888);
;// CONCATENATED MODULE: ./node_modules/@deckdeckgo/highlight-code/dist/esm/languages-ed1137e5.js
...
const CarbonThemeStyle = ({ style }) => {
  return ((0,index_5f714435.h)("style", null, `
      :host ${style};
    `));
};
...
let HighlightCode = class {
  constructor(hostRef) {
    (0,index_5f714435.r)(this, hostRef);
    this.prismLanguageLoaded = (0,index_5f714435.c)(this, "prismLanguageLoaded", 7);
    this.prismLanguageError = (0,index_5f714435.c)(this, "prismLanguageError", 7);
    /**
  ...
  render() {
    ...
    return ((0,index_5f714435.h)(index_5f714435.H, { class: hostClass }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), (0,index_5f714435.h)("div", { class: "container", ref: (el) => (this.refContainer = el) }, (0,index_5f714435.h)("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, ref: (el) => (this.refCode = el) }), (0,index_5f714435.h)("slot", { name: "code" }), this.editable && (0,index_5f714435.h)("deckgo-highlight-code-edit", { label: this.editableLabel }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return (0,index_5f714435.h)(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.CARBON) {
      return undefined;
    ...
    return [
      (0,index_5f714435.h)(CarbonThemeStyle, { style: this.themeStyle }),
      (0,index_5f714435.h)("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green'))
    ];
  }
  renderCarbonCircle(color) {
    return (0,index_5f714435.h)("div", { class: color });
  }
  renderUbuntu() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.UBUNTU) {
      return undefined;
    }
    return ((0,index_5f714435.h)("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), (0,index_5f714435.h)("p", null, (0,index_5f714435.h)("slot", { name: "user" }))));
  }
  renderUbuntuCircle(mode) {
    const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
    return ((0,index_5f714435.h)("div", { class: mode }, (0,index_5f714435.h)("span", { innerHTML: symbol })));
  }
  get el() { return (0,index_5f714435.g)(this); }
...
let Edit = class {
  constructor(hostRef) {
    (0,index_5f714435.r)(this, hostRef);
    this.editCode = (0,index_5f714435.c)(this, "editCode", 7);
  }
  render() {
    return ((0,index_5f714435.h)("button", { onClick: () => this.editCode.emit(), "aria-label": this.label || 'Edit code', part: "edit-button" }, (0,index_5f714435.h)("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor", part: "edit-icon" }, (0,index_5f714435.h)("path", { d: "M0 0h24v24H0z", fill: "none" }), (0,index_5f714435.h)("path", { d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" }))));
  }
};
Edit.style = editCss;
